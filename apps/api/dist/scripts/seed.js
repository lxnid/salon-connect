...
async function main() {
    ...
    // Sample salon owner
    const salonOwner = await prisma_1.prisma.user.create({
        data: {
            email: 'owner@example.com',
            password: hashedPassword,
            role: prisma_1.UserRole.SALON_OWNER,
            firstName: 'David',
            lastName: 'Johnson',
    ...
    const stylistUser1 = await prisma_1.prisma.user.create({
        data: {
            email: 'sarah@example.com',
            password: hashedPassword,
            role: prisma_1.UserRole.STYLIST,
            firstName: 'Sarah',
            lastName: 'Johnson',
            phone: '+1 (555) 234-5678',
        },
    });
    const stylistUser2 = await prisma_1.prisma.user.create({
        data: {
    ...
    // Create stylists
    const stylist1 = await prisma_1.prisma.stylist.create({
        data: {
    ...
    const stylist2 = await prisma_1.prisma.stylist.create({
        data: {
    ...
    const services = await Promise.all([
        prisma_1.prisma.service.create({
            data: {
                name: "Women's Haircut",
                description: 'Professional haircut and styling',
                category: prisma_1.ServiceCategory.HAIRCUT,
                duration: 45,
                price: 65,
                salonId: salon.id,
            },
        ...
        prisma_1.prisma.service.create({
            data: {
                ...
                category: prisma_1.ServiceCategory.COLORING,
                duration: 120,
                price: 120,
                salonId: salon.id,
            },
        ...
        prisma_1.prisma.service.create({
            data: {
                ...
                category: prisma_1.ServiceCategory.STYLING,
                duration: 30,
                price: 45,
                salonId: salon.id,
            },
    ...
    await Promise.all([
        ...services.map(service => prisma_1.prisma.stylistService.create({
            data: {
                stylistId: stylist1.id,
                serviceId: service.id,
            },
        })),
        ...services.slice(0, 3).map(service => prisma_1.prisma.stylistService.create({
            data: {
    ...
    await Promise.all([
        ...scheduleData.map(schedule => prisma_1.prisma.stylistSchedule.create({
